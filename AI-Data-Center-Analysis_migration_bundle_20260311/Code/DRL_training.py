...
def main() -> None:
    ...
    experiment_name = f"{experiment_date}_SAC_DC_Cooling-{environment}"
    ...
    total_timesteps = int(args.timesteps) if args.timesteps is not None else args.episodes * timesteps_per_episode
