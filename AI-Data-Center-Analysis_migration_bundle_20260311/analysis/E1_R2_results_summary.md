...
**交接文档**：`项目目标/handoff_2026-04-17.md`
...
| seed | SOC 均值 | SOC 标准差 | valve 均值 | charge% | discharge% | 年等效循环 |
|------|----------|-----------|-----------|---------|------------|-----------|
...
**严重问题**：
- 所有 seed 的 valve 几乎永久停留在充电方向（charge% ≥ 60%，多数 ≥ 95%）
...
- 第 6 个 action（TES valve）**退化成"常数略开充电阀"**，没学到任何时段策略
