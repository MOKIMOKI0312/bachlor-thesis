                ...
                if self.best_model_save_path is not None:
                    self.model.save(
                        os.path.join(
                            ...
                            "model.zip"))
                    mean_var_path=self.eval_env.get_wrapper_attr('workspace_path')
                    os.rename(mean_var_path+'/mean.txt', mean_var_path+'/mean_best.txt')
                    os.rename(mean_var_path+'/var.txt', mean_var_path+'/var_best.txt')
