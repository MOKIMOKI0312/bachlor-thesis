...
warnings.filterwarnings(
    ...
    module=r'opyplus\.weather_data\.weather_data')

# ---------------------------------------------------------------------------- #
#                               Generic constants                              #
# ---------------------------------------------------------------------------- #
# Sinergym Data path
PKG_DATA_PATH = str(resources.files('sinergym').joinpath('data')) + os.sep
...
YEAR = 1991
# project-scoped output root
PKG_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
# Keep Sinergym outputs inside the bundled project unless explicitly overridden.
CWD = os.environ.get('SINERGYM_OUTPUT_ROOT', os.path.join(PKG_ROOT, 'runs'))
