...
$LogDir = "logs/w2_scenario_batch_$TS"
...
Run-Cmd -Tag "w2_mpc_milp_year_$TS" -CellArgs @(
...
Run-Cmd -Tag "w2_mpc_heuristic_year_$TS" -CellArgs @(
    "tools/m2_tes_mpc_oracle.py",
...
# Cell 3: no-TES baseline (policy=neutral, valve always 0)
Run-Cmd -Tag "w2_baseline_neutral_year_$TS" -CellArgs @(
