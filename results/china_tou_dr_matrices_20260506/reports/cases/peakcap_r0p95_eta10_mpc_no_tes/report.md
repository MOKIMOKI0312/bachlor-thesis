# peakcap_r0p95_eta10_mpc_no_tes

- Category: `Peak-cap`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\peakcap_r0p95_eta10_mpc_no_tes`
...
| Steps | 2880 |
| Total cost CNY | 1,344,961.86 |
| Grid import kWh | 14,282,764.26 |
| Peak grid kW | 20,035.50 |
| Temp violation degree-hours | 428.9985 |
| Fallback count | 0 |
| Solve time p95 s | 2.2384 |
| Final SOC | 0.5000 |
...
- 该 case 的月总成本为 1,344,961.86 CNY，峰值购电为 20,035.50 kW。
- 存在温度约束压力：温度违约为 428.999 degree-hours，最高温度 29.206 C。
- 求解过程中未触发 fallback。
- 与配对场景 `peakcap_r0p95_eta10_mpc_tes` 相比，`mpc_no_tes -> mpc` 的 TES 增量为 增加成本 98.73 CNY/月。
