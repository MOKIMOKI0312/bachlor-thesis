# peakcap_r0p95_eta20_mpc_no_tes

- Category: `Peak-cap`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\peakcap_r0p95_eta20_mpc_no_tes`
...
| Steps | 2880 |
| Total cost CNY | 1,344,849.25 |
| Grid import kWh | 14,282,426.73 |
| Peak grid kW | 20,035.50 |
| Temp violation degree-hours | 430.6639 |
| Fallback count | 0 |
| Solve time p95 s | 2.1809 |
| Final SOC | 0.5000 |
...
- 该 case 的月总成本为 1,344,849.25 CNY，峰值购电为 20,035.50 kW。
- 存在温度约束压力：温度违约为 430.664 degree-hours，最高温度 29.206 C。
- 求解过程中未触发 fallback。
- 与配对场景 `peakcap_r0p95_eta20_mpc_tes` 相比，`mpc_no_tes -> mpc` 的 TES 增量为 增加成本 208.61 CNY/月。
