# peakcap_r0p97_eta5_mpc_no_tes

- Category: `Peak-cap`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\peakcap_r0p97_eta5_mpc_no_tes`
...
| Steps | 2880 |
| Total cost CNY | 1,328,966.69 |
| Grid import kWh | 14,297,774.15 |
| Peak grid kW | 20,457.30 |
| Temp violation degree-hours | 0.0002 |
| Fallback count | 0 |
| Solve time p95 s | 1.0111 |
| Final SOC | 0.5000 |
...
- 该 case 的月总成本为 1,328,966.69 CNY，峰值购电为 20,457.30 kW。
- 存在温度约束压力：温度违约为 0.000 degree-hours，最高温度 27.001 C。
- 求解过程中未触发 fallback。
- 与配对场景 `peakcap_r0p97_eta5_mpc_tes` 相比，`mpc_no_tes -> mpc` 的 TES 增量为 节省 555.88 CNY/月。
