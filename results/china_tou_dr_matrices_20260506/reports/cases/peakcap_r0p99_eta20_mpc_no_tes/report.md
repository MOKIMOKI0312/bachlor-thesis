# peakcap_r0p99_eta20_mpc_no_tes

- Category: `Peak-cap`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\peakcap_r0p99_eta20_mpc_no_tes`
...
| Steps | 2880 |
| Total cost CNY | 1,307,956.63 |
| Grid import kWh | 14,277,029.76 |
| Peak grid kW | 20,879.10 |
| Temp violation degree-hours | 0.0002 |
| Fallback count | 0 |
| Solve time p95 s | 0.3159 |
| Final SOC | 0.5000 |
...
- 该 case 的月总成本为 1,307,956.63 CNY，峰值购电为 20,879.10 kW。
- 存在温度约束压力：温度违约为 0.000 degree-hours，最高温度 27.001 C。
- 求解过程中未触发 fallback。
- 与配对场景 `peakcap_r0p99_eta20_mpc_tes` 相比，`mpc_no_tes -> mpc` 的 TES 增量为 节省 207.64 CNY/月。
