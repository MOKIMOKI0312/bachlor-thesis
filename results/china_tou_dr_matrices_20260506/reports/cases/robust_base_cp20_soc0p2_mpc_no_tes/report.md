# robust_base_cp20_soc0p2_mpc_no_tes

- Category: `Robustness`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\robust_base_cp20_soc0p2_mpc_no_tes`
...
- 求解过程中未触发 fallback。
- 与配对场景 `robust_base_cp20_soc0p2_mpc_tes` 相比，`mpc_no_tes -> mpc` 的 TES 增量为 节省 11.65 CNY/月。
