# robust_dr_day_ahead_10_h24_mpc_no_tes

- Category: `Robustness`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\robust_dr_day_ahead_10_h24_mpc_no_tes`
...
| Steps | 2880 |
| Total cost CNY | 1,302,180.63 |
| Grid import kWh | 14,292,346.48 |
| Peak grid kW | 21,090.00 |
| Temp violation degree-hours | 0.0000 |
| Fallback count | 0 |
| Solve time p95 s | 0.3838 |
| Final SOC | 0.5000 |
...
- 该 case 的月总成本为 1,302,180.63 CNY，峰值购电为 21,090.00 kW。
- 温度违约为 0，当前代理模型下满足温度约束。
- 求解过程中未触发 fallback。
- 与配对场景 `robust_dr_day_ahead_10_h24_mpc_tes` 相比，`mpc_no_tes -> mpc` 的 TES 增量为 节省 1,471.06 CNY/月。
...
|:-----------|:--------------------------------------|:-------------|:-------------------------------------------|----------------------:|--------------------------:|-----------------------:|----------------:|-----------------------------:|--------------------------:|-----------------:|
| dr_event   | robust_dr_day_ahead_10_h24_mpc_no_tes | day_ahead    | 2025-07-20 18:00:00 to 2025-07-20 19:45:00 |                 38000 |                      3800 |                2060.78 |        0.542311 |                            0 |                         0 |          6182.34 |
