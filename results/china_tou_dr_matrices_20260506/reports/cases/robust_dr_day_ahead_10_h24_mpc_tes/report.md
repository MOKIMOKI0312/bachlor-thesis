# robust_dr_day_ahead_10_h24_mpc_tes

- Category: `Robustness`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\robust_dr_day_ahead_10_h24_mpc_tes`
...
| Controller | mpc |
| Steps | 2880 |
| Total cost CNY | 1,300,709.57 |
| Grid import kWh | 14,283,957.75 |
| Peak grid kW | 21,090.00 |
| Temp violation degree-hours | 0.0000 |
| Fallback count | 1 |
| Solve time p95 s | 0.2002 |
| Final SOC | 0.2558 |
| TES charge kWh_th | 402,691.07 |
| TES discharge kWh_th | 335,893.11 |
| DR event count | 1 |

## Analysis

- 该 case 的月总成本为 1,300,709.57 CNY，峰值购电为 21,090.00 kW。
- 温度违约为 0，当前代理模型下满足温度约束。
- 该 case 出现 1 次 fallback；可行率为 1.000000。
- 与配对场景 `robust_dr_day_ahead_10_h24_mpc_no_tes` 相比，`mpc_no_tes -> mpc` 的 TES 增量为 节省 1,471.06 CNY/月。
...
|:-----------|:-----------------------------------|:-------------|:-------------------------------------------|----------------------:|--------------------------:|-----------------------:|----------------:|-----------------------------:|--------------------------:|-----------------:|
| dr_event   | robust_dr_day_ahead_10_h24_mpc_tes | day_ahead    | 2025-07-20 18:00:00 to 2025-07-20 19:45:00 |                 38000 |                      3800 |                2060.78 |        0.542311 |                       6225.4 |                         0 |          6182.34 |
