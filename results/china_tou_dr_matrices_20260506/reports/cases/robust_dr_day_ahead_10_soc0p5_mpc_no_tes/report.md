# robust_dr_day_ahead_10_soc0p5_mpc_no_tes

- Category: `Robustness`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\robust_dr_day_ahead_10_soc0p5_mpc_no_tes`
...
- 求解过程中未触发 fallback。
- 与配对场景 `robust_dr_day_ahead_10_soc0p5_mpc_tes` 相比，`mpc_no_tes -> mpc` 的 TES 增量为 节省 641.81 CNY/月。
...
|:-----------|:-----------------------------------------|:-------------|:-------------------------------------------|----------------------:|--------------------------:|-----------------------:|----------------:|-----------------------------:|--------------------------:|-----------------:|
| dr_event   | robust_dr_day_ahead_10_soc0p5_mpc_no_tes | day_ahead    | 2025-07-20 18:00:00 to 2025-07-20 19:45:00 |                 38000 |                      3800 |                2060.78 |        0.542311 |                            0 |                         0 |          6182.34 |
