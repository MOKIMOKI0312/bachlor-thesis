# tou_full_base_mild_mpc_tes

- Category: `TOU full compare`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\tou_full_base_mild_mpc_tes`
...
- 求解过程中未触发 fallback。
- 与配对场景 `tou_full_base_mild_mpc_no_tes` 相比，`mpc_no_tes -> mpc` 的 TES 增量为 增加成本 315.09 CNY/月。
