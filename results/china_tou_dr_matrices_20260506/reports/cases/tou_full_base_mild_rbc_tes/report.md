# tou_full_base_mild_rbc_tes

- Category: `TOU full compare`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\tou_full_base_mild_rbc_tes`
...
- 该 case 的月总成本为 1,278,982.51 CNY，峰值购电为 20,198.55 kW。
