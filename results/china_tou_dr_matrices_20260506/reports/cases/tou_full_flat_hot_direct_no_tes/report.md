# tou_full_flat_hot_direct_no_tes

- Category: `TOU full compare`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\tou_full_flat_hot_direct_no_tes`
...
- 该 case 的月总成本为 1,289,412.44 CNY，峰值购电为 21,011.25 kW。
