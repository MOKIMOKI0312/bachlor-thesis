# tou_full_flat_mild_direct_no_tes

- Category: `TOU full compare`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\tou_full_flat_mild_direct_no_tes`
...
- 该 case 的月总成本为 1,236,545.39 CNY，峰值购电为 20,255.25 kW。
