# tou_full_flat_mild_rbc_tes

- Category: `TOU full compare`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\tou_full_flat_mild_rbc_tes`
...
| Controller | rbc |
| Steps | 2880 |
| Total cost CNY | 1,237,388.17 |
| Grid import kWh | 13,755,171.75 |
| Peak grid kW | 20,198.55 |
| Temp violation degree-hours | 0.0000 |
| Fallback count | 0 |
| Solve time p95 s | 0.0000 |
| Final SOC | 0.6477 |
| TES charge kWh_th | 158,625.00 |
| TES discharge kWh_th | 118,125.00 |
| DR event count | 0 |

## Analysis

- 该 case 的月总成本为 1,237,388.17 CNY，峰值购电为 20,198.55 kW。
