# tou_screen_g0p5_cp0p2_mild_mpc_no_tes

- Category: `TOU screening`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\tou_screen_g0p5_cp0p2_mild_mpc_no_tes`
...
| Steps | 2880 |
| Total cost CNY | 1,244,889.27 |
| Grid import kWh | 13,703,764.73 |
| Peak grid kW | 21,090.00 |
| Temp violation degree-hours | 0.0000 |
| Fallback count | 0 |
| Solve time p95 s | 0.3222 |
| Final SOC | 0.5000 |
...
- 该 case 的月总成本为 1,244,889.27 CNY，峰值购电为 21,090.00 kW。
- 温度违约为 0，当前代理模型下满足温度约束。
- 求解过程中未触发 fallback。
- 与配对场景 `tou_screen_g0p5_cp0p2_mild_mpc_tes` 相比，`mpc_no_tes -> mpc` 的 TES 增量为 节省 1,228.30 CNY/月。
