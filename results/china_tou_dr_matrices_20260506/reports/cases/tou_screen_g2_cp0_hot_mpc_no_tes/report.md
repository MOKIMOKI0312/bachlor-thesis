# tou_screen_g2_cp0_hot_mpc_no_tes

- Category: `TOU screening`
- Raw run directory: `results\china_tou_dr_matrices_20260506\raw\tou_screen_g2_cp0_hot_mpc_no_tes`
...
- 该 case 的月总成本为 1,434,156.90 CNY，峰值购电为 21,090.00 kW。
- 温度违约为 0，当前代理模型下满足温度约束。
- 求解过程中未触发 fallback。
- 与配对场景 `tou_screen_g2_cp0_hot_mpc_tes` 相比，`mpc_no_tes -> mpc` 的 TES 增量为 节省 710.23 CNY/月。
